# Generated by Django 5.1.4 on 2025-02-08 16:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MockAssessmentTestContent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('last_update_date', models.DateTimeField(auto_now=True, verbose_name='Последнее обновление')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MockAssessmentTest.mockassessmenttest', verbose_name='Тест')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MockAssessmentTest.mockassessmenttestcontent', verbose_name='Тест контент')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='MockAssessmentTestFullDescription',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='MockAssessmentTestInstruction',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='MockAssessmentUserStatistic',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MockAssessmentTest.mockassessmenttest', verbose_name='Тест')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MockAssessmentTest.mockassessmentuser', verbose_name='Пользователь')),
            ],
            options={
