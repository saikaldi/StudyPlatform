...
from .views import TestCategoryViewSet, TestViewSet, TestContentViewSet, TestFullDescriptionViewSet, TestInstructionViewSet, AdditionalInstructionViewSet, UserAnswerViewSet, UserStatisticViewSet
