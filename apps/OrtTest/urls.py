...
from .views import TestCategoryViewSet, TestViewSet, TestContentViewSet, TestFullDescriptionViewSet, TestInstructionViewSet, UserAnswerViewSet, UserStatisticViewSet #AdditionalInstructionViewSet
